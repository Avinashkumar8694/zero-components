...
export class CyberTheme extends BaseTheme {
    id = 'cyber';
    name = 'Cyberpunk';
    globalTokens = cyberGlobalTokens;
    componentTokens = cyberComponentTokens;
    baseStyles = css`
        :host {
        ...
        /* Advanced Cyberpunk Structural Overrides */
        .uiv-cyber-card {
        ...
        @keyframes cyber-pulse {
            0%, 100% { opacity: 0.8; }
            50% { opacity: 1; text-shadow: 0 0 15px var(--uiv-primary-color); }
        }
